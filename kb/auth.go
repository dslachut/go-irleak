...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.go-irleak.yaml)")
...
func initConfig() {
	...
	viper.SetConfigName(".go-irleak") // name of config file (without extension)
